    ...
    return (
        <AppLayout>
            ...
            <div className="max-w-[1200px] mx-auto space-y-xl">
                <section className="flex flex-col md:flex-row items-center md:items-end gap-md">
                    ...
                    <div className="text-center md:text-left">
                        ...
                        <p className="font-body-md text-body-md text-on-surface-variant">Atur data diri dan informasi klinis Anda</p>
                    </div>
                </section>

                <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                    <div className="md:col-span-8 bg-surface-container-lowest rounded-lg p-md shadow-[0_10px_30px_-5px_rgba(2,103,131,0.06)]">
                        <div className="flex items-center gap-2 mb-md">
                            <span className="material-symbols-outlined text-primary">person</span>
                            <h2 className="font-headline-md text-headline-md text-primary">Data Diri</h2>
                        </div>
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
                                ...
                                <div>
                                    <label className="font-label-md text-label-md text-on-surface mb-1 block">Tanggal Lahir</label>
                                    <input type="date" value={data.birth_date} onChange={e => setData('birth_date', e.target.value)}
                                        className="w-full rounded-xl border border-outline-variant bg-surface px-4 py-3 text-body-md text-on-surface focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all" />
                                    {errors.birth_date && <span className="text-xs text-error font-label-sm">{errors.birth_date}</span>}
                                </div>
                                <div>
                                    <label className="font-label-md text-label-md text-on-surface mb-1 block">Jenis Kelamin</label>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        <label className="font-label-md text-label-md text-on-surface mb-1 block">Tinggi (cm)</label>
                                    ...
                                    <div>
                                        <label className="font-label-md text-label-md text-on-surface mb-1 block">Berat (kg)</label>
                                ...
                                <div className="md:col-span-2">
                                    <label className="font-label-md text-label-md text-on-surface mb-1 block">Alergi</label>
                                    <textarea value={data.allergies} onChange={e => setData('allergies', e.target.value)}
                                        className="w-full rounded-xl border border-outline-variant bg-surface px-4 py-3 text-body-md text-on-surface resize-none h-24 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                            ...
                            <button type="submit" disabled={processing}
                                className="w-full mt-lg py-3 bg-primary text-on-primary rounded-full font-label-md shadow-lg hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-50">
                    ...
                    <div className="md:col-span-4 space-y-6">
                        <div className="bg-primary-container text-on-primary-container rounded-lg p-md shadow-[0_10px_30px_-5px_rgba(2,103,131,0.06)] flex flex-col justify-between overflow-hidden relative">
                            <div className="z-10">
                                <h3 className="font-label-md uppercase opacity-80">Skor Kesehatan</h3>
                                <p className="font-display-lg text-display-lg">--<span className="text-headline-md">/100</span></p>
                            </div>
                        ...
                        <div className="bg-surface-container-lowest rounded-lg p-md shadow-[0_10px_30px_-5px_rgba(2,103,131,0.06)]">
                            <h2 className="font-headline-md text-headline-md text-primary mb-md">Pengaturan</h2>
                            <div className="space-y-2">
                                <button className="w-full flex items-center justify-between p-sm hover:bg-surface-container transition-colors rounded-md group">
