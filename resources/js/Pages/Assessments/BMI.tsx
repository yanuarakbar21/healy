    ...
    return (
        <AppLayout>
            ...
            <div className="max-w-xl mx-auto space-y-6">
                <h1 className="font-headline-lg text-headline-lg text-on-surface">Kalkulator BMI</h1>

                <div className="bg-surface-container-lowest rounded-lg p-lg md:p-xl shadow-[0_30px_60px_-15px_rgba(2,103,131,0.06)]">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div>
                            <label className="font-label-md text-label-md text-on-surface mb-1 block">Tinggi Badan (cm)</label>
                        ...
                        <div>
                            <label className="font-label-md text-label-md text-on-surface mb-1 block">Berat Badan (kg)</label>
                ...
                {result && (
                    <div className="bg-surface-container-lowest rounded-lg p-lg md:p-xl shadow-[0_30px_60px_-15px_rgba(2,103,131,0.06)] text-center">
                        <p className="font-label-md text-label-md text-on-surface-variant">Skor BMI Anda</p>
