    ...
    return (
        <AppLayout>
            ...
            <div className="space-y-6">
                <div>
                    <h1 className="font-headline-lg text-on-surface">Skrining Kesehatan</h1>
                    <p className="font-body-md text-on-surface-variant mt-1">Pilih tes untuk memeriksa kondisi kesehatan Anda</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {tests.map((test) => (
                        <Link key={test.href} href={test.href}>
                            <div className="bg-surface-container-lowest rounded-lg p-10 shadow-[0_10px_30px_-5px_rgba(2,103,131,0.06)] h-full hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer flex flex-col">
                                ...
                                <h3 className="font-headline-md text-[18px] text-on-surface mb-3">{test.title}</h3>
                                <p className="font-body-md text-on-surface-variant flex-1">{test.desc}</p>
